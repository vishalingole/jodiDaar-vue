            ...
            <v-card class="elevation-1 pa-3">
              <v-card-text>
                <div class="layout column align-center">
                 ...
                 <h2 class="flex my-1">Forgot My Password</h2>
                 <div class="flex my-3">Please provide your e-mail below. We will send you instructions to reset your password. </div>
                </div>
              ...
              <v-card-actions >
                <v-spacer></v-spacer>
                <v-btn outline color="primary" @click="login" :loading="loading" small class="text-md-center">SUBMIT</v-btn>
              </v-card-actions>
              <v-divider></v-divider>
              <v-layout row>
                <v-flex xs7>
                ...
                <v-flex xs5 align-content-end>
                  <v-card-title primary-title class="green--text">
                    <div>
                      <div><router-link class="green--text" to="/">Sign In</router-link></div>
