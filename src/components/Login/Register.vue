            ...
            <v-card class="elevation-1 pa-3">
              <v-card-text>
                <div class="layout column align-center">
                  ...
                  <h2 class="flex my-4 ">Register New Account </h2>
              ...
              <v-card-actions >
                <v-spacer></v-spacer>
                <v-btn outline color="primary" @click="login" :loading="loading" small class="text-md-center">Register</v-btn>
              </v-card-actions>
              <v-divider></v-divider>
              <v-layout row>
                <v-flex xs7>
                ...
                <v-flex xs5 align-content-end>
                  <v-card-title primary-title class="green--text darken-4">
                    <div>
                      ...
                      <div><router-link class="green--text" to="register">Find More Help</router-link></div>
                    </div>
                  </v-card-title>
                </v-flex>
              </v-layout>
